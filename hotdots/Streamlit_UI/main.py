...
df = pd.read_csv('hotdots/Streamlit_UI/CdSe_BetterthanRaw.csv')
...
st.write(f'Predicted diameter is {predicted[0, 0]:.3f}.\n',
         f'Predicted absorbance max is {predicted[0, 1]:.2f} \n',
         f'Predicted emission is {predicted[0, 2]:.2f}')
